...
`),ve=F(n.FRAGMENT_SHADER,`
    ...
    }`,P.supportLinearFiltering?null:["MANUAL_FILTERING"]),et=F(n.FRAGMENT_SHADER,`
    precision mediump float;
    precision mediump sampler2D;
    varying highp vec2 vUv;
